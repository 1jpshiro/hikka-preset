...
from telethon.tl.messages import GetWebPagePreviewRequest
...
class HikkaInfoMod(loader.Module):
    ...
    def _render_info(self, inline: bool) -> str:
        ...
        for emoji, icon in [
            ...
            ("🥔", "<emoji document_id=5188511666857329554>🥔</emoji>"),
        ]:
        ...
        if self.config["custom_button"]:
            ...
            await self.inline.form(
                ...
                **(
                    ...
                    if self.config["banner_url"] and file.webpage.type != "gif"
                    else ""
                ),
            )
        else:
